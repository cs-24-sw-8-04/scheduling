...
class DateRangeTest {
    ...
    fun dateRangeTest() {
        ...
        assert(date1.getStartDate() == "01/01/1970") { "Should equal epoch date, not ${date1.getStartDate()}" }
        assert(date1.getEndDate() == "17/08/292278994") { "Should equal 17/08/292278994, not ${date1.getEndDate()}" }
